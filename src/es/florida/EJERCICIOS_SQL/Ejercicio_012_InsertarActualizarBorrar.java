...
public class Ejercicio_012_InsertarActualizarBorrar {
...
//	INSERT INTO peliculas (id, titulo, director, puntuacion, genero) VALUES (0,'tituloPelicula', 'directorPelicula', '5.6', 'generoPelicula')
//	DELETE FROM peliculas WHERE id = 3
//	UPDATE peliculas SET director='Harry Potter' WHERE id=1
