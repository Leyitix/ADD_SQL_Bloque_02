...
public class Ejercicio_009_ActualizarXML {
	...
	public static void actualizarPelicula(int id) {
		...
		if (!nuevoValor.equals(" "))
			pelicula.setTitulo(nuevoValor);
		System.out.println("Actualizar director: ");
		nuevoValor = teclado.nextLine();
		if (!nuevoValor.equals(" "))
			pelicula.setDirector(nuevoValor);
		System.out.println("Actualizar genero: ");
		nuevoValor = teclado.nextLine();
		if (!nuevoValor.equals(" "))
			pelicula.setGenero(nuevoValor);
		System.out.println("Actualizar duracion: ");
		nuevoValor = teclado.nextLine();
		if (!nuevoValor.equals(" "))
			pelicula.setDuracion(nuevoValor);
		System.out.println("Actualizar estreno: ");
		nuevoValor = teclado.nextLine();
		if (!nuevoValor.equals(" "))
			pelicula.setEstreno(nuevoValor);

		int indice = 0;
		for (Pelicula p : lista.getListaPeliculas()) {
			if (p.getId().equals(identificador)) {
				lista.getListaPeliculas().set(indice, pelicula);
				break;
			}
			indice++;
		}
	...
	public static void main(String[] args) {
		...
		Scanner teclado = new Scanner(System.in);
		System.out.println("Indica la pelicula que quieres actualizar: ");
